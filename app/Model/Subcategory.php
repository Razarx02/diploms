...
class Subcategory extends AppModel {
	...
	public $validate = array(
		...
		// 		'message' => 'Максимальный размер картинки 5MB'
		// 	),
	...
	public function customUploadImg($file = array()){
		...
		$path = WWW_ROOT . 'img/subcategories/' . $fileName;
	
		$path_th = WWW_ROOT . 'img/subcategories/thumbs/' . $fileName;
	...
	public function genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img/subcategories/' . $name)){
